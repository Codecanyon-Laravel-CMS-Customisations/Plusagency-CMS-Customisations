...
class CourseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('image')) {
            ...
            @mkdir($dir, 0775, true);
            @copy(str_replace(' ', '%20', $image), $dir . $filename);
        ...
        if ($request->filled('instructor_image')) {
            ...
            @mkdir($dir, 0775, true);
            @copy(str_replace(' ', '%20', $insImage), $directory . $filename);
    ...
    public function update(Request $request)
    {
        ...
        if ($request->filled('image')) {
            ...
            $filename = uniqid() .'.'. $extImage;
            @copy(str_replace(' ', '%20', $image), 'assets/front/img/courses/' . $filename);
            $course->course_image = $filename;
        }
        ...
        if ($request->filled('instructor_image')) {
            ...
            @copy(str_replace(' ', '%20', $insImage), 'assets/front/img/instructors/' . $filename);
            $course->instructor_image = $filename;
        }
