...
<div class="page-header">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a href="#">Product Categories Menu Builder</a>
        </li>
    </ul>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="card-title">Product Categories Menu Builder</div>
                    </div>
                    <div class="col-lg-2">
                        @if (!empty($langs))
                ...
                <div class="row no-gutters">
                    <div class="col-lg-4">
                        <div class="card border-primary mb-3">
                            <div class="card-header bg-primary text-white">Select Product Menus</div>
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    @foreach ($cats as $cat)
                                        <li class="list-group-item">
                                            {{$cat->name}}
                                            <a data-text="{{$cat->name}}" data-type="product_categories-megamenu" data-custom="yes" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                        </li>
                                    @endforeach
    ...
    jQuery(document).ready(function () {
        ...
        // $('#btnReload').on('click', function () {
            ...
            $('#btnOutput').on('click', function () {
                ...
                $.ajax({
                    url: "{{route('admin.category_menu_builder.update')}}",
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
