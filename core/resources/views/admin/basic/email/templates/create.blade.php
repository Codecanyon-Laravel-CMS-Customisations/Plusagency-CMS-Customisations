    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">Create Email Template</div>
...
{{--                        @endif--}}
              ...
              <form id="ajaxForm" action="{{route('admin.email.templates.store')}}" method="post" enctype="multipart/form-data">
                @csrf

                @php
                        $etype = str_replace("_", " ", "custom_email_".rand(6677, 9999));
                @endphp
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="email_subject"  placeholder="Email Subject">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <div class="form-group">
                         ...
                         <textarea class="form-control summernote" name="email_body" placeholder="Enter description" data-height="300"></textarea>
