                            ...
                            <div class="space-top-2 px-4 px-xl-5 px-wd-7 pb-5">
                                ...
                                <div class="px-3 d-flex mb-5 align-items-center">
                                    ...
                                    @else
                                        ...
                                        <div class="product-quantity d-flex d-md-none" id="quantity"
                                        ...
                                        <a data-href="{{ $pvariation ? route('add.cart', $pvariation->id) : route('add.cart', $product->id) }}"
                                            class="mb-4 mb-md-0 btn btn-dark border-0 rounded-0 p-3 min-width-250 ml-md-4 single_add_to_cart_button button alt cart-btn cart-link my-1"
                                        ...
                                        @if ($product->show_inquiry_form)
                                            ...
                                            <a href="javascript:;" data-href="javascript:;"
                                                class="btn btn-dark border-0 rounded-0 p-3 min-width-250 min-width-250-----naaah ml-md-4 single_add_to_cart_button button alt cart-btn cart-link my-1"
                                            ...
                                            <div class="col-sm-12 col-md-3">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <a href="{{ $url }}?variation={{ $variation->id }}"><img
                                                            {{-- <img src="{{ asset('assets/' . json_decode($variation->variation_data)->thumbnail) }}" alt="" width="75" style="border-radius: 50%; @if (isset($_GET['variation']) && $_GET['variation'] == $variation->id) border: 1px solid black; @endif"> --}} <img
                                                            src="{{ asset(json_decode($variation->variation_data)->thumbnail) }}"
                                                            alt="" width="75"
