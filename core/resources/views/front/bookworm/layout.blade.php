...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/bookworm/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/bookworm/vendor/slick-carousel/slick/slick.css') }}"/>
    <link rel="stylesheet" href="{{ asset('assets/bookworm/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}">
    ...
    @if (!request()->routeIs('front.index') && !request()->routeIs('front.packageorder.confirmation'))
        <div class="page-header border-bottom">
            <div class="container">
                ...
                // dd($name);
                $product = \App\Product::where('title', '=', $name)
                                ->first();
                if(!empty($product)) {
...
{{--    <script src="{{ asset('assets/bookworm/vendor/jquery/dist/jquery.min.js') }}"></script>--}}
    ...
    <script src="{{ asset('assets/bookworm/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>
